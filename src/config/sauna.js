...
export const MODELS = {
  'city-elegant': {
    name: 'City Elegant',
    colors: [
      { id: 'black', label: 'Black', swatch: '#1A1A1A', folder: encode('/elegant-new/black'), glb: encode('/elegant-new/Sauna City Elegant.glb') },
      { id: 'brown', label: 'Brown', swatch: '#6B4226', folder: encode('/elegant-new/brown'), glb: encode('/elegant-new/Sauna City Elegant.glb'),
